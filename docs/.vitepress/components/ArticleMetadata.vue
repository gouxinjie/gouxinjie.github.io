...
/**
 * @description  获取文章字数及阅读时间，主要应用到 H1标题下面
 * @author gxj
 * @date 2025-08-10
 */
...
<template>
  <div class="word">
    <p>
      ...
      <span class="word-m"> 更新: {{ date.toLocaleDateString() }}</span>
      ...
      <span class="word-m">字数: {{ wordCount }} 字</span>
      <svg
        t="1724572797268"
        class="icon"
      ...
      <span class="word-m"> 时长: {{ readTime }} 分钟</span>
    </p>
  </div>
</template>

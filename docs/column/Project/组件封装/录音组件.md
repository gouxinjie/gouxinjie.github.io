      ...
      <div className="recording-panel" ref={panelRef}>
        ...
        <div className="recording-panel-content">
          <p className="recording-tip">
            {isUploading ? "正在识别语音..." : isRecording ? `已录制 ${formatTime(recordingTime)}` : "点击下方按钮开始录音"}
          </p>
          ...
          <button
            className={`voice-button-pc ${isRecording ? "recording" : ""}`}
            onClick={isRecording ? stopRecording : startRecording}
            disabled={hasPermission === false || isUploading}
          >
            {isUploading ? (

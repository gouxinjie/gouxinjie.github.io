    ...
    items: [
      {
        icon: "",
        name: "npm",
        desc: "Node.js官方包管理工具，拥有最大的JavaScript包生态系统",
        link: "https://www.npmjs.com/"
      },
      {
        icon: "",
        name: "yarn",
        desc: "Facebook开发的包管理工具，提供确定性安装和离线模式",
      ...
      },
      {
        icon: "",
        name: "corepack",
        desc: "Node.js内置包管理器管理器，统一yarn/pnpm体验",
        link: "https://nodejs.org/api/corepack.html"
      },
      {
        icon: "",
        name: "Bun",
        desc: "新兴的JavaScript运行时，内置快速包管理器",
        link: "https://bun.sh/"
      }
    ]
  },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        icon: "",
        name: "Grunt",
        desc: "老牌JavaScript任务运行器",
        link: "https://gruntjs.com/"
      },
      {
        icon: "",
        name: "npm scripts",
        desc: "利用npm内置的脚本功能实现任务自动化",

...
const siteData = [
  {
    ...
    items: [
      ...
      },
      {
        icon: "",
        name: "Nuxt.js",
        desc: "基于 Vue.js 的轻量级应用框架，支持SSR和静态站点生成",
        link: "https://www.nuxtjs.cn/"
      },
      {
        icon: "",
        name: "VueHooks Plus",
        desc: "Vue3 的 Hooks基础和高级的 hook，满足大量场景",
        link: "https://inhiblabcore.github.io/docs/hooks/guide/"
      },
      {
        icon: "",
        name: "VueUse",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        icon: "",
        name: "dumi",
        desc: "基于 Markdown 的文档站点生成器，简单易用，功能强大",
        link: "https://d.umijs.org/"
      },
      {
        icon: "",
        name: "Docusaurus",
        desc: "基于 React 的静态站点生成器，简单易用，功能强大",
